  ...
  return (
    <div className='min-h-screen flex flex-col justify-center md:px-32 px-5 p-4 m-2'>
      <div className='flex flex-col md:flex-row items-center space-y-5'>
        ...
        <div>
          <div>
            <h1 className='text-4xl font-playFar font-medium text-center'>Build your needs with Archmove</h1>
          </div>
          <div className='flex flex-row gap-5 p-5 md:pl-24'>
            <img src={icon1} alt='' />
            <div>
              <h3 className='font-semibold pb-3'>100% guaranted project completion</h3>
          ...
          <div className='flex flex-row gap-5 p-5 md:pl-24'>
            <img src={icon2} alt='' />
            <div>
              <h3  className='font-semibold pb-3'>No additonal fees</h3>
              <p className='w-4/5 text-slate-300'>
